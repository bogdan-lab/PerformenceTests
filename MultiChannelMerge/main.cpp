...
BENCHMARK(GenerateSourceBM)->ArgsProduct({{10, 100, 1000}, {10, 100, 1000}});
BENCHMARK(SetSolutionBM)->ArgsProduct({{10, 100, 1000}, {10, 100, 1000}});
BENCHMARK(HeapSolutionBM)->ArgsProduct({{10, 100, 1000}, {10, 100, 1000}});
